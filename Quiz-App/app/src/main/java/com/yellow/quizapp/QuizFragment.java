...
import com.yellow.quizapp.model.QuestionsModel;
...
import static com.yellow.quizapp.utils.Common.QUESTIONS;
import static com.yellow.quizapp.utils.Common.QUIZLIST;
...
public class QuizFragment extends Fragment implements View.OnClickListener{
    ...
    private void resetOptions() {
        ...
        optionOneBtn.setTextColor(getResources().getColor(R.color.colorPrimary,null));
        optionTwoBtn.setTextColor(getResources().getColor(R.color.colorPrimary,null));
        optionThreeBtn.setTextColor(getResources().getColor(R.color.colorPrimary,null));
